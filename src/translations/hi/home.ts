const home = {
    ...
    "home.feature1.description":
        "एक सुरक्षित सैंडबॉक्स वातावरण में वास्तविक Git कमांड के साथ करके सीखें। कुछ भी तोड़ने के डर के बिना अभ्यास करें।",
    "home.feature2.title": "मिनी गेम्स",
    "home.feature2.description":
        "मजेदार चुनौतियों के साथ Git कौशल का अभ्यास करें और पुरस्कार अनलॉक करने के लिए अंक अर्जित करें। सीखने को आकर्षक और सुखद बनाएं।",
