const home = {
    ...
    "home.feature1.description":
        "با انجام دادن با دستورات واقعی Git در یک محیط امن سندباکس یاد بگیرید. بدون ترس از خراب کردن چیزی تمرین کنید.",
    "home.feature2.title": "بازی‌های کوچک",
    "home.feature2.description":
        "مهارت‌های Git را با چالش‌های سرگرم‌کننده تمرین کنید و امتیاز کسب کنید تا پاداش‌ها را باز کنید. یادگیری را اعتیادآور و لذت‌بخش کنید.",
